...
class Add_Inbetween(bpy.types.Operator):
...
class Keyframe_Nudge_Panel(bpy.types.Panel):
    ...
    bpy.types.Scene.slider =  bpy.props.FloatProperty(min=0,max=1, update=update_inbetween)
...
def register():
    ...
    bpy.utils.register_class(Add_Inbetween)
...
def unregister():
    ...
    bpy.utils.unregister_class(Add_Inbetween)
