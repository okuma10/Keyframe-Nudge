...
class UVRectangle2:
    def __init__(self,width,height):
        ...
        self.circS = height*.20
        self.lineW = height*.04
        self.mouse = Vector3([self.h_width,0,0])
        self.end_points = Vector4([0+10,0,
                                    width-10,0])
        # self.WidHei     = [shape_size[0]*2, shape_size[1]/3]
        #n Data
        self.vertices   = [
    ...
    def draw(self,program,proj,view):
        ...
        self.program.setVec4('idleColor', *self.idleColor)
        self.program.setVec4('overColor', *self.overColor)
        self.program.setVec4('pressColor', *self.activeColor)
        self.program.setVec4('points', *self.end_points)
        self.program.setVec3('mouse', *self.mouse)
        self.program.setVec2('resolution', *self.dimensions)
        self.program.setVec2('position', 0, self.h_height)
        self.program.setFloat('lineWidth', self.lineW)
        self.program.setFloat('circleSize', self.circS)
    ...
    def setMouse(self,mouseX,mouseY,state):
        self.mouse = Vector3([mouseX,mouseY,state])
