...
class UVRectangle:
    def __init__(self,width,height, shape_size, shape, shader):
        self.program = shader
        self.state = 0
        self.shape = shape
    ...
    def draw(self,proj,view):
        ...
        self.program.setVec2('size', *self.WidHei)
        self.program.setFloat('width',4.5)
        self.program.setVec2('dimensions', *self.dimensions)
        self.program.setInt('state', self.state)
        self.program.setInt('shape', self.shape)
